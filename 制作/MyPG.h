...
namespace  MyPG
{
	...
	//----------------------------------------------
		...
		//------------------------------------------------------------------
		enum class GAMESTATE { INIT, WAIT, START, PLAY, STOP, CLEAR, CHANGESTAGE, END };
		struct GameSystem {
			GAMESTATE gameState;
			int timeCount;
			int maxStage;
		...
		MapObject::Object::SP qa_MapObject;
		DebugLog::Object::SP qa_Debug;
		shared_ptr<vector<Box::Object::SP>> qa_Boxs;
		shared_ptr<vector<TeleportGate::Object::SP>> qa_TeleportGates;
		FPSCounter fps = FPSCounter::FPSCounter(60.0f);
